...
<body>
  ...
  <div class="container">
    ...
    <div class="text-center d-flex justify-content-between align-items-center mb-5">
          ...
          <section class="seccion">
            <form action="login_masterd/val_usuario.php" method="POST">
              ...
              <div class="mb-3">
                ...
                <br>
                <input type="submit" class="btn btn-primary btn-ingresar" id="boton_ingreso" value="Ingresar" />
