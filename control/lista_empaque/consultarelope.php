...
$query=mysqli_query($conexion,"SELECT listaEmpaque.*, pedidos2.`codigoP` AS pedido FROM listaEmpaque INNER JOIN pedidos2 ON listaEmpaque.`pedidoId` = pedidos2.`idP` WHERE  mold LIKE '%$referencia%'   AND pedidoId LIKE '%$pedidoId%' AND lote LIKE '%$lote%'  AND Fecha LIKE '%$fecha%'  ");
