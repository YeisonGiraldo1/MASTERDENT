...
<p style="font-size:20px;">  Si eliminas este  producto no podra  recuperarse, esto significa que toda la informacion relacionada  con este  desaparecera  de la base de datos del sistema de forma permanente. </p>
<br><br>

<form action="eliminardefinitivo.php" method="GET">
  <input type="text" name="id"  value="<?php  echo $id;?>"  hidden>
    <input type="text" name="color"  value="<?php  echo $color?>"  hidden>
      <input type="text" name="referencia"  value="<?php $referencia ?>"  hidden>
