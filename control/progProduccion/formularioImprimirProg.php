...
<head>
    ...
    <title>Formulario Impresión</title>
...
<body>
    ...
    <center><h1>Ingrese los datos del turno que desea imprimir</h1>
    <div class="container mt-5">
        <div class="row">
            <form action="imprimirProgramacion1.php" method="POST">
...
<br>
  ...
  <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="aImprimir" class="form-label">Qué desea imprimir?</label>
                    <select class="form-select" id="aImprimir" name="aImprimir" aria-label="Default select example">
                        
                        <option value="">Selecciona</option>
                        <option value="1">Hoja de producción</option>
                        <option value="2">Etiquetas/Rótulos</option>
