            ...
            <table class="table table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="vistas/modulos/eliminar_lotes.php?id=<?php echo $mostrar['id']; ?>"><i style="color: red;" class="fas fa-trash"></i></a></td>
<td><a href="vistas/modulos/editar_lotes.php?id=<?php echo $mostrar['id']; ?>"><i class="fas fa-edit"></i> </a></td>
