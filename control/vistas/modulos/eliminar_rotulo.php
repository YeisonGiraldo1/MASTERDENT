...
<p style="font-size:20px;">  Si eliminas este  dato de la tabla Rotulos, no podras  recuperarlo, esto significa que toda la informacion relacionada  con este  desaparecera  de la base de datos del sistema de forma permanente. </p>
<br><br>

<form action="elim_rotdef.php" method="GET">
...
<form action="verTablaRotulos.php" method="GET">
  <input type="text" name="id"  value="<?php  echo $id;?>"  hidden>
