...
<p style="font-size:20px;">  Si eliminas este  dato de la tabla lotes, no podras  recuperarlo, esto significa que toda la informacion relacionada  con este  desaparecera  de la base de datos del sistema de forma permanente. </p>
<br><br>

<form action="eliminarLoteDefinitivo.php" method="GET">
