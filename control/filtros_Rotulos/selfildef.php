...
if(isset($_GET['err'])){
  ...
  echo "<h1  style='color:red;text-align:center;'> LA  FECHA  DESDE  DEBE SER MENOR QUE  HASTA  POR  FAVOR INTENTA  NUEVAMENTE</h1>";
}
?>
<br>
<button type="button"  style="margin-left:80%;"><a  href="../filtros_Rotulos/filtrados.php">REGRESAR</a></button>
  ...
  <form action="brfech_Rotulos/valcheckbox.php" method="POST"> 
