...
$query = mysqli_query($conexion, "SELECT * FROM  rotulos2  where id = '$id' ");
      ...
      <br><br>
        ...
        <div class="mb-3">
          ...
          <form  action="bacedit4.php"  method="POST" >
            ...
            <label for=referencia class="form-label"  hidden>desde</label>
 <input type="text" class="form-control" value="<?php   echo $desde; ?>"  id="desde" name="desde"  required  hidden>
 <label for=referencia class="form-label" hidden>hasta</label>
 <input type="text" class="form-control" value="<?php   echo $hasta; ?>"  id="hasta" name="hasta"  required  hidden>
...
<label for="color" class="form-label">VUELTA 1</label>
 ...
 <input type="text" class="form-control"  value="<?php   echo$data['estado']; }}?>"    id="estado" name="estado"  required>
